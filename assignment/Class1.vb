...
Public Class Class1
    Public Function Loadkhachang() As DataSet
        Dim chuoiketnoi As String = "workstation id=tuanbmpk00429dtb.mssql.somee.com;packet size=4096;user id=vinet4u_SQLLogin_1;pwd=38ufsxsz6k;data source=tuanbmpk00429dtb.mssql.somee.com;persist security info=False;initial catalog=tuanbmpk00429dtb"
